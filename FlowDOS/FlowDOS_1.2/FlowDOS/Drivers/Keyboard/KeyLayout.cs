...
namespace FlowDOS.Drivers.Keyboard
{
    class KeyLayout
    {
        ...
        {
            Cosmos.Hardware.Global.Keyboard.ChangeKeyMap(keys);
        }
        ...
        {
            keys.Add(new Cosmos.Hardware.Keyboard.KeyMapping(p, p_2, p_3));
            KeyCount += 1u;
        }
        ...
        {
            keys = new List<Cosmos.Hardware.Keyboard.KeyMapping>(164);
            #region Keys
            ...
            AddKeyWithShift(79u, '1', ConsoleKey.NumPad1);
            AddKeyWithShift(80u, '2', ConsoleKey.NumPad2);
            AddKeyWithShift(81u, '3', ConsoleKey.NumPad3);
            AddKeyWithShift(75u, '4', ConsoleKey.NumPad4);
            AddKeyWithShift(76u, '5', ConsoleKey.NumPad5);
            AddKeyWithShift(77u, '6', ConsoleKey.NumPad6);
            AddKeyWithShift(71u, '7', ConsoleKey.NumPad7);
            AddKeyWithShift(72u, '8', ConsoleKey.NumPad8);
            AddKeyWithShift(73u, '9', ConsoleKey.NumPad9);
            AddKeyWithShift(72u, '0', ConsoleKey.NumPad0);
            #endregion
            ChangeKeyMap();
        }
        ...
        public static void QWERTZ()
        {
            ...
            // Other keys
            AddKeyWithShift(79u, '1', ConsoleKey.NumPad1);
            AddKeyWithShift(76u, '2', ConsoleKey.NumPad2);
            AddKeyWithShift(81u, '3', ConsoleKey.NumPad3);
            AddKeyWithShift(75u, '4', ConsoleKey.NumPad4);
            AddKeyWithShift(76u, '5', ConsoleKey.NumPad5);
            AddKeyWithShift(76u, '6', ConsoleKey.NumPad6);
            AddKeyWithShift(76u, '7', ConsoleKey.NumPad7);
            AddKeyWithShift(76u, '8', ConsoleKey.NumPad8);
            AddKeyWithShift(76u, '9', ConsoleKey.NumPad9);
            AddKeyWithShift(76u, '0', ConsoleKey.NumPad0);
            #endregion
            ChangeKeyMap();
        }
