/* MD5.cs - An implementation of an MD5 hash.
 * Ported to Cosmos from http://farazmahmood.wordpress.com/projects/md5-implementation-in-c/
 * All applicable edits:
...
namespace NoobOS.Encryption
{
    ...
    public class Digest
    {
        ...
        private string ToHexString(uint aNumber, byte aBits)
        {
            uint xValue = aNumber;
