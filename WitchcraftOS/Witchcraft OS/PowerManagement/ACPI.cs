...
namespace WitchcraftOS.Witchcraftfx.PowerManagement
{
        // 
        // here is the slighlty complicated ACPI code translated from c
        //
        public static unsafe class ACPI
        {
            ...
            public static void Shutdown()
            {
                ...
                if (pm1aIO != null)
                {
                    ...
                    //CPUBus.Write16((ushort)ACPI.PM1a_CNT, (ushort)(ACPI.SLP_TYPa | ACPI.SLP_EN));
                    if (PM1b_CNT != null)
                        pm1bIO.Word = (ushort)(SLP_TYPb | SLP_EN);
                    //CPUBus.Write16((ushort)ACPI.PM1b_CNT, (ushort)(ACPI.SLP_TYPb | ACPI.SLP_EN));
                }
