...
namespace WitchcraftOS.Witchcraftfx.Games
{
    public static class Snake
    {
        ...
        public static void Start()
        {
            ...
            Output.WriteLine("YOU LOSE!", ConsoleColor.Red, true);
            Console.CursorTop++;
            Output.WriteLine("Your score: " + score.ToString(), ConsoleColor.White, true);
        }
    }
}
